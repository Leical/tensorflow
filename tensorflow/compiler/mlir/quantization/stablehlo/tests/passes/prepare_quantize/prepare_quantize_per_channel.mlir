...
module {
  ...
  func.func private @conv_with_bias_and_relu(%arg0: tensor<1x3x2x3xf32>) -> tensor<1x2x2x2xf32> {
    ...
    %1 = "tf.XlaCallModule"(%0, %cst_0, %cst) {
      ...
      _quantization_method = "static_range_ptq {input_quantized_types {key: 1, value {granularity {dimension_specs {dimension: 3}}}}}",
...
// does not have a `input_quantized_types` with a specified `granularity`.
...
// `_quantization_method` attribute without a `granularity` field in
// `QuantizedType`.
