...
//       key: 1,
//       value {granularity {dimension_specs {dimension: 3}}}}}
//   }}
// }
QuantizationSpec GetStaticRangePtqSpecForConvolution() {
  ...
  // Assumes NHWC format, specifying the channel dimension as quantized axis.
  conv_weight_quantized_type.mutable_granularity()
      ->mutable_dimension_specs()
      ->set_dimension(3);  // Channel dimension.
